...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in to ShelfOS with your Google account to open the register, manage inventory, and review store reports.",
      },
      { property: "og:title", content: "Sign In — ShelfOS" },
      {
        property: "og:description",
        content: "Secure Google sign-in for the ShelfOS offline-first retail POS.",
      },
    ],
  }),
  component: LoginPage,
