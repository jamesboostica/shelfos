    ...
    return (
      <div className="space-y-3 text-center">
        ...
        <p className="text-sm text-slate-500">
          We sent a password reset link to <span className="font-semibold">{email.trim()}</span>.
          Open it, choose a new password, then come back and sign in.
        </p>
        <button
          type="button"
  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <p className="text-center text-sm text-slate-500">
        {mode === "signup" ? "Already have an account?" : mode === "reset" ? "Remembered it?" : "No account?"}{" "}
        <button
          type="button"
